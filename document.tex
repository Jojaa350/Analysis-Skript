...
\subsection{maximal ein Grenzwert}
Jede reelle Folge hat max. einen Grenzwert. Wer lesen kann, ist klar im Vorteil. Und wer das hier jetzt noch immer liest, ist doof.
...
\begin{itemize}
	\item konvex, falls $f(\alpha x + (1 - \alpha)y) \leq \alpha f(x) + (1 - \alpha)f(y)$
	\item streng konvex, falls $f(\alpha x + (1 - \alpha)y) < \alpha f(x) + (1 - \alpha)f(y)$
	\item konkav, falls $f(\alpha x + (1 - \alpha)y) \geq \alpha f(x) + (1 - \alpha)f(y)$
	\item streng konkav, falls $f(\alpha x + (1 - \alpha)y) > \alpha f(x) + (1 - \alpha)f(y)$
\end{itemize}
\end{document}
