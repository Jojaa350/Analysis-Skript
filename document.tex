...
% indent the subsections a little to avoid overlap between the number and the title
\makeatletter
...
\begin{itemize}
	\item geometrische Reihe $s_n = \sum\limits_{k=0}^{n}z^k$. Konvergiert gdw. $|z| < 1$.
...
\end{equation*}
\footnotetext{$\displaystyle\lim_{n \rightarrow \infty} x = x_0$ heißt: $x$ ist unendlich nahe an $x_0$.}
...
\addcontentsline{toc}{subsection}{Definition uneigentliches Integral}
